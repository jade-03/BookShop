 ...
 */
final class Version20260917134416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE listing (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, book_condition VARCHAR(255) NOT NULL, language VARCHAR(100) NOT NULL, price NUMERIC(10, 2) NOT NULL, statut VARCHAR(255) NOT NULL, publication_date DATETIME NOT NULL, book_id INT NOT NULL, user_id INT NOT NULL, favorite_id INT DEFAULT NULL, category_id INT NOT NULL, INDEX IDX_CB0048D416A2B381 (book_id), INDEX IDX_CB0048D4A76ED395 (user_id), INDEX IDX_CB0048D4AA17481D (favorite_id), INDEX IDX_CB0048D412469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, send_at DATETIME NOT NULL, sender_id INT NOT NULL, receiver_id INT NOT NULL, listing_id INT NOT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), INDEX IDX_B6BD307FCD53EDB6 (receiver_id), INDEX IDX_B6BD307FD4619D1A (listing_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `orders` (id INT AUTO_INCREMENT NOT NULL, total NUMERIC(10, 2) NOT NULL, status VARCHAR(30) NOT NULL, order_date DATETIME NOT NULL, user_id INT NOT NULL, listing_id INT NOT NULL, payement_id INT NOT NULL, INDEX IDX_E52FFDEEA76ED395 (user_id), UNIQUE INDEX UNIQ_E52FFDEED4619D1A (listing_id), UNIQUE INDEX UNIQ_E52FFDEE868C0609 (payement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, lastname VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, pseudo VARCHAR(30) DEFAULT NULL, email VARCHAR(180) NOT NULL, role VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, profil_picture VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, favorite_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E986CC499D (pseudo), INDEX IDX_1483A5E9AA17481D (favorite_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE listing ADD CONSTRAINT FK_CB0048D4A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FD4619D1A FOREIGN KEY (listing_id) REFERENCES listing (id)');
        $this->addSql('ALTER TABLE `orders` ADD CONSTRAINT FK_E52FFDEEA76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE `orders` ADD CONSTRAINT FK_E52FFDEED4619D1A FOREIGN KEY (listing_id) REFERENCES listing (id)');
        $this->addSql('ALTER TABLE `orders` ADD CONSTRAINT FK_E52FFDEE868C0609 FOREIGN KEY (payement_id) REFERENCES payement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `orders` DROP FOREIGN KEY FK_E52FFDEED4619D1A');
        $this->addSql('ALTER TABLE `orders` DROP FOREIGN KEY FK_E52FFDEE868C0609');
        $this->addSql('ALTER TABLE picture DROP FOREIGN KEY FK_16DB4F89D4619D1A');
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E9AA17481D');
